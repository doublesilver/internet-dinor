...
export const metadata: Metadata = {
  ...
  description:
    "전국 최대 사은품! 인터넷/TV 가입 비교하고 당일설치, 당일입금 받으세요.",
};
    ...
    try {
      [builderTopContent, builderBottomContent] = await Promise.all([
        fetchOneEntry({
          ...
          userAttributes: { urlPath: "/home-top" },
        }),
        fetchOneEntry({
          model: BUILDER_MODEL,
          apiKey: BUILDER_API_KEY,
          userAttributes: { urlPath: "/home-bottom" },
        }),
      ]);
    } catch {
  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundColor: "var(--design-hero-bg, #4A86CF)" }}
      >
        <div className="container-page flex flex-col gap-5 py-8 md:flex-row md:items-start md:justify-between md:py-14">
          <div className="space-y-4 md:w-[55%]">
            ...
            >
              ...
              <span
                ...
                style={{
                  textShadow:
                    "3px 3px 0 #FFEF0A, -1px -1px 0 #FFEF0A, 1px -1px 0 #FFEF0A, -1px 1px 0 #FFEF0A, 1px 1px 0 #FFEF0A",
                }}
              >
                {settings.heroAmount}
              </span>
            ...
            <div className="space-y-2">
              <p
                ...
                style={{
                  color:
                    "var(--design-hero-subtitle-color, rgba(255,255,255,0.85))",
                  fontSize: "var(--design-hero-subtitle-font-size, 18px)",
                }}
              >
                전국 최대 사은품 지급하는 곳!
                <br />
                비밀지원금은 <span className="font-bold">빠른견적</span>을 통해
                문의해주세요.
              </p>
              <p
          ...
          <div className="md:w-[40%]">
            <div className="rounded-[25px] bg-white p-6 shadow-lg md:p-8">
              <h3 className="mb-5 text-center text-2xl font-bold text-brand-orange">
                빠른 견적 문의
              </h3>
              <QuickInquiryForm
                sourcePage="/"
                submitLabel={settings.heroCtaLabel}
              />
            </div>
          </div>
        </div>
      ...
      <section
        className="py-10 md:py-14"
        style={{ backgroundColor: "var(--design-benefits-bg, #6EA8E0)" }}
      >
        <div className="container-page">
          <div className="mb-6">
            <h2
      ...
      <section
        ...
        style={{ backgroundColor: "var(--design-cta-bg, #333333)" }}
      >
        <div className="container-page space-y-4 text-center">
          <p
            className="text-lg font-medium"
            style={{ color: "var(--design-cta-heading-color, #ffffff)" }}
          >
            너 빼고 다 신청 중..
          </p>
          <h2
          ...
          <p
            ...
            style={{ color: "var(--design-cta-heading-color, #ffffff)" }}
          >
            약정끝난 인터넷 변경하고 몰랐던 비밀지원금 왕창 받아 가자!
          </p>
          <p
        ...
        <div className="container-page">
          <div className="mb-6 text-center">
            ...
            <p className="mt-3 text-brand-slate">
              인터넷공룡을 통해 이렇게 신청하실 수 있습니다.
            </p>
            <p className="mt-1 text-xs text-gray-400">
              ※ 예시 데이터이며, 실제 신청 현황과 다를 수 있습니다.
            </p>
          </div>
          <RecentApplications />
        </div>
      ...
      {guides.length > 0 && (
        <section
          className="py-10 md:py-14"
          style={{ backgroundColor: "var(--design-tips-bg, #F5F8FC)" }}
        >
          <div className="container-page">
            <div className="mb-6 flex items-end justify-between">
              ...
              <Button
                href={getBoardCategoryHref("guide") ?? "/board/guide"}
                variant="secondary"
              >
                전체 보기
              </Button>
