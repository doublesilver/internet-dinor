  ...
  return (
    <section className="section-space">
      <div className="container-page max-w-4xl">
        <article className="surface-card prose prose-sm max-w-none space-y-8">
          ...
          <div className="space-y-6 text-sm leading-7 text-brand-slate">
            <section className="space-y-2">
              ...
              <p>
                본 약관은 {settings.siteName}(이하 &ldquo;회사&rdquo;)이 운영하는 인터넷 홈페이지(이하 &ldquo;사이트&rdquo;)를 이용함에 있어 회사와 이용자 간의 권리,
            ...
            <section className="space-y-2">
              ...
              <p>회사는 이용자의 개인정보를 보호하기 위해 개인정보처리방침을 수립하고 준수합니다. 자세한 내용은 사이트 내 &ldquo;개인정보처리방침&rdquo;을 확인하시기 바랍니다.</p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>회사와 이용자 간에 발생한 분쟁은 상호 협의하여 해결하는 것을 원칙으로 합니다. 협의가 이루어지지 않는 경우 관련 법령 및 상관례에 따르며, 소송이 필요한 경우 회사 소재지를 관할하는 법원을 관할 법원으로 합니다.</p>
            </section>
