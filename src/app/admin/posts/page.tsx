  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        <Link
          href="/admin/posts/new?entityType=post"
        ...
        <Link
          ...
          className="inline-flex rounded-2xl border border-brand-orange bg-white px-5 py-3 text-sm font-semibold text-brand-orange"
        >
          신규 후기 등록
        </Link>
      </div>
          ...
          filteredPosts.map((post) => (
            <article key={post.id} className="surface-card">
              <div className="flex items-center justify-between gap-3">
                ...
                <StatusQuickToggle
                  endpoint={`/api/admin/posts/${post.id}/status`}
