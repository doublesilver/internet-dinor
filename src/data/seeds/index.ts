...
export const siteSettingsSeed: SiteSettings = {
  ...
  footerNotice:
    "인터넷공룡은 통신사 공식 판매점으로 안전하고 빠른 상담을 제공합니다.",
  businessInfo: {
    owner: "장윤성",
...
export const carriersSeed: Carrier[] = [
  {
    ...
    heroDescription:
      "SK브로드밴드의 상품, 혜택, 요금을 직접 확인하고 비교해보세요.",
  ...
  },
  {
    ...
    heroDescription:
      "LG유플러스의 상품, 혜택, 요금을 직접 확인하고 비교해보세요.",
  ...
  },
  {
    ...
    heroDescription:
      "KT스카이라이프의 상품, 혜택, 요금을 직접 확인하고 비교해보세요.",
  ...
  },
  {
    ...
    heroDescription:
      "LG헬로비전의 상품, 혜택, 요금을 직접 확인하고 비교해보세요.",
...
export const productsSeed: Product[] = [
  // SK Products
  {
    ...
    description:
      "가족 단위에 가장 인기 있는 SK브로드밴드 대표 결합 상품입니다. 500M 인터넷과 B tv ALL 257개 채널을 합리적인 가격에 이용하세요.",
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "TV 시청이 많은 가족 단위 가구에 적합합니다. B tv ALL로 257개 채널을 마음껏 즐기세요.",
      },
      {
        title: "결합 혜택",
        body: "휴대폰 결합 시 인터넷 요금 추가 할인이 적용됩니다. 가족 회선이 많을수록 할인 폭이 커집니다.",
      },
    ],
    faqItems: [
      {
        q: "약정 기간은 어떻게 되나요?",
        a: "3년 약정 기준이며, 약정 내 해지 시 위약금이 발생합니다.",
      },
      { q: "설치비가 있나요?", a: "신규 가입 시 설치비는 무료입니다." },
      {
        q: "B tv ALL에는 어떤 채널이 포함되나요?",
        a: "지상파, 케이블, 종편 등 총 257개 채널이 포함됩니다.",
      },
    ],
    isFeatured: true,
    status: "published",
  ...
  },
  {
    ...
    description:
      "최고 속도 1G 인터넷과 B tv ALL 257채널을 함께 이용할 수 있는 프리미엄 결합 상품입니다.",
    bundleType: "internet_tv",
    internetSpeed: "1G",
    tvIncluded: true,
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "재택근무, 고화질 게임, 4K 스트리밍을 즐기는 가구에 적합합니다.",
      },
      {
        title: "속도 안내",
        body: "유선 기준 최대 1Gbps 속도로 여러 기기를 동시에 사용해도 끊김이 없습니다.",
      },
    ],
    faqItems: [
      {
        q: "실제 속도는 얼마나 나오나요?",
        a: "환경에 따라 다르지만 유선 기준 800~900Mbps 수준입니다.",
      },
      {
        q: "Wi-Fi 6 공유기가 포함되나요?",
        a: "네, 약정 기간 중 Wi-Fi 6 공유기가 무상 제공됩니다.",
      },
    ],
    isFeatured: false,
    status: "published",
  ...
  },
  {
    ...
    description:
      "합리적인 가격으로 인터넷과 TV를 함께 이용할 수 있는 실속형 결합 상품입니다.",
    bundleType: "internet_tv",
    internetSpeed: "100M",
    tvIncluded: true,
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "웹서핑, 영상 시청 위주의 1~2인 가구에 적합합니다. TV 채널도 기본 패키지로 충분히 즐길 수 있습니다.",
      },
    ],
    faqItems: [
      {
        q: "B tv 스탠다드에는 몇 개 채널이 있나요?",
        a: "약 234개 채널이 포함되어 있습니다.",
      },
      {
        q: "나중에 속도 업그레이드가 가능한가요?",
        a: "약정 중에도 업그레이드 상담이 가능합니다. 고객센터로 문의해주세요.",
      },
    ],
    isFeatured: false,
    status: "published",
  ...
  // KT Products
  {
    ...
    description:
      "안정적인 KT 인터넷과 OTV 베이직 채널 패키지를 합리적인 가격에 이용할 수 있는 대표 결합 상품입니다.",
    bundleType: "internet_tv",
    internetSpeed: "500M",
    tvIncluded: true,
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "안정적인 인터넷 품질을 원하는 가족 가구에 적합합니다. KT의 전국 최대 커버리지로 끊김 없이 이용하세요.",
      },
      {
        title: "결합 혜택",
        body: "KT 휴대폰 사용자는 추가 결합 할인을 받을 수 있습니다. 결합 회선 수에 따라 할인 폭이 커집니다.",
      },
    ],
    faqItems: [
      {
        q: "KT 휴대폰이 아니어도 가입 가능한가요?",
        a: "네, 인터넷/TV만 단독 가입 가능합니다.",
      },
      {
        q: "OTV 베이직 채널 수는 얼마나 되나요?",
        a: "약 200여 개 채널이 포함되어 있습니다.",
      },
    ],
    isFeatured: true,
    status: "published",
  ...
  },
  {
    ...
    description:
      "초고속 1G 인터넷과 OTV 에센스 채널 패키지를 결합한 프리미엄 상품입니다. 게임과 고화질 스트리밍을 즐기는 고객에게 최적입니다.",
    bundleType: "internet_tv",
    internetSpeed: "1G",
    tvIncluded: true,
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "온라인 게임, 4K 영상, VOD를 많이 시청하는 가구에 적합합니다.",
      },
      {
        title: "속도 안내",
        body: "1G 인터넷으로 여러 기기를 동시에 사용해도 끊김 없이 즐길 수 있습니다.",
      },
    ],
    faqItems: [
      {
        q: "OTV 에센스와 베이직의 차이는 무엇인가요?",
        a: "에센스는 베이직 대비 더 많은 채널과 VOD 콘텐츠가 포함되어 있습니다.",
      },
      {
        q: "1G 인터넷 실측 속도는 얼마나 되나요?",
        a: "유선 기준 800~950Mbps 수준으로 제공됩니다.",
      },
    ],
    isFeatured: false,
    status: "published",
  ...
  },
  {
    ...
    description:
      "1인 가구를 위한 경제적인 인터넷+TV 결합 상품입니다. 기본에 충실한 구성으로 합리적인 가격을 제공합니다.",
    bundleType: "internet_tv",
    internetSpeed: "100M",
    tvIncluded: true,
    monthlyPriceLabel: "39,600원",
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "혼자 사는 1인 가구 또는 인터넷 사용량이 적은 가구에 적합합니다.",
      },
    ],
    faqItems: [
      {
        q: "1인 가구에 100M으로 충분한가요?",
        a: "넷플릭스, 유튜브, 웹서핑 등 일반적인 사용에는 100M으로 충분합니다.",
      },
    ],
    isFeatured: false,
    status: "published",
  ...
  // LG Products
  {
    ...
    description:
      "합리적인 가격에 WiFi6 공유기가 포함된 LG유플러스 대표 결합 상품입니다. 500M 인터넷과 TV 베이직 채널을 함께 이용하세요.",
    bundleType: "internet_tv",
    internetSpeed: "500M",
    tvIncluded: true,
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "WiFi 포함 구성을 원하는 신혼/소규모 가구에 적합합니다. WiFi6 공유기로 빠른 무선 인터넷을 즐기세요.",
      },
      {
        title: "WiFi6 공유기",
        body: "약정 기간 중 최신 WiFi6 공유기가 무상으로 제공됩니다.",
      },
    ],
    faqItems: [
      {
        q: "WiFi 공유기가 무료인가요?",
        a: "약정 기간 중 WiFi6 공유기가 무상 제공됩니다.",
      },
      {
        q: "TV 베이직 채널 수는 얼마나 되나요?",
        a: "약 180여 개 채널이 포함되어 있습니다.",
      },
    ],
    isFeatured: true,
    status: "published",
  ...
  },
  {
    ...
    description:
      "프리미엄 안심 보장 서비스와 함께하는 LG유플러스 500M 인터넷+TV 결합 상품입니다.",
    bundleType: "internet_tv",
    internetSpeed: "500M",
    tvIncluded: true,
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "안정적인 인터넷 품질과 프리미엄 서비스를 원하는 가구에 적합합니다.",
      },
    ],
    faqItems: [
      {
        q: "프리미엄 안심 서비스란 무엇인가요?",
        a: "장애 발생 시 우선 처리 및 추가 보상 서비스가 포함됩니다.",
      },
    ],
    isFeatured: false,
    status: "published",
  ...
  },
  {
    ...
    description:
      "초고속 1G 인터넷과 TV 프리미엄 채널 패키지를 결합한 LG유플러스 최고급 상품입니다.",
    bundleType: "internet_tv",
    internetSpeed: "1G",
    tvIncluded: true,
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "고사양 온라인 게임, 4K 스트리밍을 즐기는 가구에 최적입니다.",
      },
      {
        title: "속도 안내",
        body: "1G 인터넷으로 집안 어디서나 끊김 없는 초고속 인터넷을 즐기세요.",
      },
    ],
    faqItems: [
      {
        q: "TV 프리미엄에는 어떤 채널이 포함되나요?",
        a: "지상파, 종편, 케이블, 스포츠, 영화 등 250개 이상의 채널이 포함됩니다.",
      },
      {
        q: "게임 전용 최적화가 있나요?",
        a: "LG유플러스 1G 인터넷은 저지연 최적화로 게임 환경에 유리합니다.",
      },
    ],
    isFeatured: false,
    status: "published",
  ...
  // Skylife Products
  {
    ...
    description:
      "전국 어디서나 설치 가능한 위성TV 기반 인터넷/TV 결합 상품입니다. 케이블이 없는 지역에서도 이용 가능합니다.",
    bundleType: "internet_tv",
    internetSpeed: "100M",
    tvIncluded: true,
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "케이블 미설치 지역이나 위성TV를 선호하는 가구에 적합합니다. 전국 어디서나 설치 가능합니다.",
      },
      {
        title: "SKY ALL 안내",
        body: "지상파부터 영화, 스포츠, 어린이 채널까지 모든 채널을 한 번에 이용하세요.",
      },
    ],
    faqItems: [
      {
        q: "아파트에서도 설치 가능한가요?",
        a: "네, 위성 안테나 설치가 가능한 환경이면 가능합니다.",
      },
      {
        q: "인터넷이 없는 지역에서도 TV 이용이 가능한가요?",
        a: "위성TV는 인터넷 환경과 무관하게 전국 어디서나 이용 가능합니다.",
      },
    ],
    isFeatured: true,
    status: "published",
  ...
  },
  {
    ...
    description:
      "500M 고속 인터넷과 스카이라이프 SKY ALL 채널 패키지를 결합한 추천 상품입니다.",
    bundleType: "internet_tv",
    internetSpeed: "500M",
    tvIncluded: true,
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "빠른 인터넷과 다양한 TV 채널을 원하는 가족 가구에 적합합니다.",
      },
    ],
    faqItems: [
      {
        q: "500M 인터넷도 전국 설치가 가능한가요?",
        a: "네, 스카이라이프 서비스 지역 내 전국 설치가 가능합니다.",
      },
    ],
    isFeatured: false,
    status: "published",
  ...
  },
  {
    ...
    description:
      "200M 인터넷과 스카이라이프 SKY ALL 채널을 가성비 좋게 이용할 수 있는 상품입니다.",
    bundleType: "internet_tv",
    internetSpeed: "200M",
    tvIncluded: true,
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "100M보다 빠른 인터넷을 원하지만 비용을 아끼고 싶은 가구에 적합합니다.",
      },
    ],
    faqItems: [
      {
        q: "200M 인터넷이면 4K 영상도 볼 수 있나요?",
        a: "네, 200M으로도 4K 스트리밍을 충분히 즐길 수 있습니다.",
      },
    ],
    isFeatured: false,
    status: "published",
  ...
  // Internet Only Products
  {
    ...
    description:
      "TV 결합 없이 인터넷만 단독으로 이용하는 SK브로드밴드 500M 상품입니다. 군더더기 없이 빠른 인터넷만 필요한 분께 최적입니다.",
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "TV를 잘 보지 않는 1~2인 가구나 OTT 서비스만 이용하는 고객에게 적합합니다.",
      },
    ],
    faqItems: [
      {
        q: "나중에 TV를 추가할 수 있나요?",
        a: "약정 중에도 TV 결합 상담이 가능합니다. 고객센터로 문의해주세요.",
      },
    ],
    isFeatured: false,
    status: "published",
  ...
  // Hellovision Products
  {
    ...
    description:
      "지역 케이블 기반으로 저렴한 가격에 인터넷과 TV를 이용할 수 있는 헬로비전 대표 실속 상품입니다.",
    bundleType: "internet_tv",
    internetSpeed: "100M",
    tvIncluded: true,
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "최저 비용으로 인터넷+TV를 이용하고 싶은 가구에 적합합니다. 지역 케이블 기반의 안정적인 서비스를 제공합니다.",
      },
    ],
    faqItems: [
      {
        q: "헬로비전은 어느 지역에서 이용 가능한가요?",
        a: "LG헬로비전 서비스 지역 내에서 이용 가능합니다. 설치 전 지역 확인이 필요합니다.",
      },
      {
        q: "TV 이코노미 채널 수는 얼마나 되나요?",
        a: "약 109개 채널이 포함되어 있습니다.",
      },
    ],
    isFeatured: true,
    status: "published",
  ...
  },
  {
    ...
    description:
      "헬로비전에서 가장 많은 고객이 선택한 500M 인터넷+TV 뉴베이직 결합 상품입니다.",
    bundleType: "internet_tv",
    internetSpeed: "500M",
    tvIncluded: true,
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "가장 많은 고객이 선택한 조합으로, 인터넷과 TV를 균형 있게 이용하고 싶은 가구에 적합합니다.",
      },
    ],
    faqItems: [
      {
        q: "TV 뉴베이직 채널 수는 얼마나 되나요?",
        a: "약 150개 이상의 채널이 포함되어 있습니다.",
      },
    ],
    isFeatured: false,
    status: "published",
  ...
  },
  {
    ...
    description:
      "500M 인터넷과 109개 TV 채널을 합리적인 가격에 이용할 수 있는 헬로비전 추천 상품입니다.",
    bundleType: "internet_tv",
    internetSpeed: "500M",
    tvIncluded: true,
    ...
    detailSections: [
      {
        title: "추천 대상",
        body: "빠른 인터넷 속도는 원하지만 TV 채널은 기본으로 충분한 가구에 적합합니다.",
      },
    ],
    faqItems: [
      {
        q: "500M 이코노미와 500M 뉴베이직의 차이는 무엇인가요?",
        a: "TV 채널 수의 차이입니다. 이코노미는 109채널, 뉴베이직은 150채널 이상입니다.",
      },
    ],
    isFeatured: false,
    status: "published",
...
export const postsSeed: Post[] = [
  // Events
  {
    ...
    title: "현금 사은품받자~",
    summary:
      "인터넷 가입 시 현금 사은품을 받을 수 있는 기회! 지금 바로 상담받으세요.",
...
export const reviewsSeed: Review[] = [
  {
    ...
    summary:
      "오전에 신청했는데 오후에 바로 기사님이 오셔서 설치해주셨습니다. 사은품도 당일 입금!",
  ...
  },
  {
    ...
    summary:
      "약정 만료 후 상담받았는데 통신사 변경 시 사은품이 3배 차이 났습니다.",
  ...
  },
  {
    ...
    summary:
      "기존 통신사 약정 끝나고 KT로 변경했는데 사은품이 두 배 이상 차이 났어요.",
  ...
  },
  {
    ...
    summary:
      "결혼 준비하면서 인터넷이랑 TV 같이 알아봤는데 결합이 훨씬 저렴하더라구요.",
  ...
  },
  {
    ...
    summary:
      "케이블이 안 들어오는 지역이라 포기했었는데 스카이라이프로 해결됐어요.",
  ...
  {
    id: "34343434-3434-3434-3434-34343434343d",
    slug: "review-1711900000000",
    title: "상담사분이 정말 친절하게 설명해주셨어요",
    summary:
      "처음 인터넷 가입하는데 하나하나 비교해주셔서 쉽게 결정할 수 있었습니다.",
    body: "처음 인터넷 가입하는데 어떤 통신사가 좋은지 몰라서 상담 신청했습니다. 상담사분이 각 통신사별 장단점을 하나하나 비교해주셔서 쉽게 결정할 수 있었어요. 설치도 빨랐고 전체적으로 만족합니다.",
  ...
  {
    id: "34343434-3434-3434-3434-34343434343e",
    slug: "review-1711900000001",
    title: "이사할 때 인터넷 해지하고 새로 가입했는데 사은품이 좋아요",
    summary:
      "이사하면서 통신사 변경했는데 사은품도 받고 요금도 저렴해졌습니다.",
    body: "이사하면서 기존 통신사 해지하고 새로 가입했습니다. 인터넷공룡에서 상담받으니 해지 위약금도 보상해주는 상품을 안내받았고, 사은품도 넉넉하게 받았습니다. 다음에도 여기서 상담받을 예정입니다.",
    reviewType: "moving",
    tags: [],
    featured: false,
    authorName: "박지영",
