    ...
    >
      ...
      <div className="space-y-2">
        ...
        <div className="max-h-[120px] overflow-y-auto rounded-xl border border-brand-border bg-gray-50 p-3 text-xs leading-relaxed text-gray-500">
          ...
          <p className="mb-1">
            <strong>1. 수집 항목:</strong> 이름, 연락처(휴대폰 번호)
          </p>
          <p className="mb-1">
            <strong>2. 수집 목적:</strong> 인터넷/TV 상품 상담 및 가입 안내,
            사은품 지급 관련 연락
          </p>
          <p className="mb-1">
            <strong>3. 보유 기간:</strong> 상담 완료 후 1년 이내 파기 (단, 관계
            법령에 따라 보존이 필요한 경우 해당 기간 동안 보존)
          </p>
          <p className="mb-1">
            <strong>4. 동의 거부 권리:</strong> 개인정보 수집 및 이용에 대한
            동의를 거부하실 수 있으나, 이 경우 상담 서비스 제공이 제한될 수
            있습니다.
          </p>
          <p className="mb-1">
            <strong>5. 제3자 제공:</strong> 수집된 개인정보는 상담 목적 외에
            제3자에게 제공되지 않습니다.
          </p>
          <p className="mb-1">
            <strong>6. 위탁:</strong> 원활한 서비스 제공을 위해
            통신사(SK브로드밴드, KT, LG유플러스 등)에 가입 처리 목적으로
            개인정보 처리를 위탁할 수 있습니다.
          </p>
          <p>
            <strong>7. 웹 수집 제한:</strong> 계좌번호, 카드번호, 상세 주소 등
            민감한 정보는 웹에서 수집하지 않고 상담 과정에서 별도 확인합니다.
          </p>
        </div>
      </div>
