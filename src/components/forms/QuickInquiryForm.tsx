    ...
    <form id={formId} onSubmit={onSubmit} className="surface-card space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="max-h-[120px] overflow-y-auto rounded-xl border border-brand-border bg-gray-50 p-3 text-xs leading-relaxed text-gray-500">
          ...
          <p className="mb-1"><strong>3. 보유 기간:</strong> 상담 완료 후 1년 이내 파기 (단, 관계 법령에 따라 보존이 필요한 경우 해당 기간 동안 보존)</p>
          ...
          <p className="mb-1"><strong>6. 위탁:</strong> 원활한 서비스 제공을 위해 통신사(SK브로드밴드, KT, LG유플러스 등)에 가입 처리 목적으로 개인정보 처리를 위탁할 수 있습니다.</p>
          <p><strong>7. 웹 수집 제한:</strong> 계좌번호, 카드번호, 상세 주소 등 민감한 정보는 웹에서 수집하지 않고 상담 과정에서 별도 확인합니다.</p>
        </div>
      </div>
