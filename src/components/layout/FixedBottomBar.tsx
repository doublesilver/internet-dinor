    ...
    <div className="fixed bottom-0 left-0 right-0 z-40">
      ...
      <div className="flex justify-end pr-4">
        <button
          ...
          className="flex h-8 w-10 items-center justify-center rounded-t-lg bg-brand-orange text-white shadow-md"
          aria-label={collapsed ? "하단 메뉴 열기" : "하단 메뉴 닫기"}
        >
          <svg
            width="16"
            height="16"
      ...
      {/* Bottom bar content */}
      {!collapsed && (
        <div className="border-t border-brand-border bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.1)]">
          <div className="mx-auto flex max-w-5xl items-stretch divide-x divide-brand-border">
            <a
