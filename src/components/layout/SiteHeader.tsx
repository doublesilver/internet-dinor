    ...
    <header className="sticky top-0 z-30 bg-white shadow-sm" role="banner">
      ...
      <div className="border-b border-brand-border">
        <div className="container-page flex items-center justify-between gap-4 py-3">
          ...
          <a
            ...
            className="hidden items-center gap-2 text-xl font-black text-brand-orange lg:flex"
          >
      ...
      <div className="hidden border-b border-brand-border bg-brand-surface lg:block">
        <div className="container-page">
          <nav aria-label="통신사 네비게이션" className="flex items-center gap-6 py-2 text-sm font-medium text-brand-slate">
